...
Melhorias de performance: Diversas otimizações de código tornaram as operações de scan e disparo de missões mais rápidas.

Novo Banco de Dados: Migramos do SQLite para o PostgreSQL. Isso traz mais robustez, suporte a concorrência e segurança para o gerenciamento de múltiplos administradores.
